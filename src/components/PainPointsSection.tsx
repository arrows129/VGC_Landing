...
export default function PainPointsSection() {
    return (
        <section className="bg-neutral-950 py-24 px-6 md:px-16 text-white">
            <div className="max-w-5xl mx-auto text-center mb-20 px-4 md:px-8">
                <motion.h2
                ...
                <p className="text-gray-400 mt-4 text-base md:text-lg max-w-xl mx-auto leading-relaxed">
                    Discover how we transform outdated workflows into
                ...
                >
                    ...
                    <div className="bg-gradient-to-r from-[#ffd900] to-[#013e95] text-white p-6 md:p-8 rounded-lg shadow-lg max-w-2xl w-full mx-auto text-center">
                        ...
                        <p className="text-sm text-white/90 mb-6">
                            Join hundreds of modern founders using TrackD2C to
                            grow faster, smarter, and stress-free.
                        </p>
                        <button
                            onClick={() => {
